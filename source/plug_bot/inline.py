...
async def answer(client, inline_query):
    reply_markup = InlineKeyboardMarkup(
            [[
             ...
             [
             InlineKeyboardButton("➪︎𝗦𝗢𝗨𝗥𝗖𝗘 𝗖𝗢𝗕𝗥𝗔⚙",url="https://t.me/VFF35"),
             ],
             [
             InlineKeyboardButton("🔺️ - لتنصيب حسابك - 🔻",url="https://t.me/V8Y_1"),
             ]]
             )
    await inline_query.answer(
        results=[
            InlineQueryResultArticle(
                ...
                url="https://t.me/VFF35",
                description="➪︎𝗦𝗢𝗨𝗥𝗖𝗘 𝗖𝗢𝗕𝗥𝗔⚙",
