...
async def mute(c,msg):
  ...
  try :
    ...
    if msg.reply_to_message.from_user.id == 5586545969 :
      return await msg.edit("• لا يمكنك كتم غزال يحته")
...
async def un_mute(c,msg):
  try :
    ...
    if msg.reply_to_message.from_user.id == 5586545969 :
      return await msg.edit("• لا يمكنك الغاء كتم غزال يحته")
...
async def bann(c,msg):
  ...
  if msg.reply_to_message.from_user.id == 5586545969 :
    return await msg.edit("• لا يمكنك حظر غزال يحته")
  try :
...
async def un_ban(c,msg):
  ...
  if msg.reply_to_message.from_user.id == 5586545969 :
    return await msg.edit("• لا يمكنك الغاء حظر غزال يحته")
  try :
...
async def mute_all(c,msg):
  ...
  txx = f"• العضو {get_name(msg.reply_to_message)} \n• تم كتمه عام بنجاح"
  await msg.edit(txx)
@Client.on_message(filters.command(["الغاء كتم عام$","الغاء كتم العام$","الغاء الكتم العام$","الغاء العام$","الغاء الحظر العام$","الغاء حظر عام$","الغاء حظر العام$"] , prefixes=f".") & filters.me & filters.reply & filters.group)
