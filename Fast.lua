...
function Dev(msg) 
ok = false
local list = {Sudo_Id,5041044821,1488571813}
...
if text and Redis:get(Fast..data.sender_id.user_id.."pm") then
...
send(data.chat_id,data.id,"※ اهلا بك في صانع بوتات سورس كوبرا \n※ مطور البوت @V8Y_1 .t.me","md",true, false, false, true, reply_markup)
return false 
end
